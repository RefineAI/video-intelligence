...
class App {
  ...
  initRouter() {
    ...
    this.router.on({
      ...
      '/search/:query': (params) => {
       ...
       '/web/:query': (params) => {
        this.renderPage('web', params.query);
      }      ,       
       '/internet/:query': (params) => {
        this.renderPage('internet', params.query);
      }
    })
    .resolve();
  }
  ...
  renderPage(page, data) {
    ...
    switch(page) {
      ...
      case 'web': this.currentPage = new WebPage(this.$stage, this.router, data); break;
      case 'internet': this.currentPage = new InternetPage(this.$stage, this.router, data); break;
    }
